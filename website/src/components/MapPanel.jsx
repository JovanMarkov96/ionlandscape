...
const createStyle = (isDark) => ({
    ...
    sources: {
        ...
        // Structural Fix Source (Generated by generate-tiles.ps1)
        'local-tiles': {
            type: 'vector',
            url: 'pmtiles://' + (typeof window !== 'undefined' ? window.location.origin : '') + '/ionlandscape/map/serbia.pmtiles'
        }
    },
    ...
    layers: [
        ...
        // Admin boundaries (excluding Kosovo line in base map if possible, but hard to filter specific lines without IDs)
        // Instead, we render base boundaries, then overlay ours potentially.
        {
            id: 'admin-boundary',
            type: 'line',
            source: 'openmaptiles',
        ...
        // OVERLAY: Local Tiles for Serbia/Kosovo (Structural Fix)
        // This layer renders boundaries from our custom tile generation
        {
            id: 'local-boundary',
            type: 'line',
            source: 'local-tiles',
            'source-layer': 'boundary',
            filter: ['==', 'admin_level', 2], // Only show country borders (Kosovo is admin-4 in this source)
            paint: {
                'line-color': '#4f46e5', // Highlight color for verified boundary
                'line-width': 2
            }
        },
        // Place labels - cities
