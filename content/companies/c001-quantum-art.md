...
approach:
  ...
  - 2D architecture
  differentiators:
  - Dynamically reconfigurable multi-core architecture
  - Multi-tone, multi-mode coherent control over all qubits at once
  elevator_pitch: We employ multi-qubit gates, implementing up to 1,000 standard two-qubit
    gates in a single operation... Made possible by multi-tone, multi-mode coherent
    control.
entity_type: company
focus_areas:
...
links:
  ...
  linkedin: ''
  news: https://quantum-art.tech/news
