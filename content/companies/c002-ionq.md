...
approach:
  ...
  differentiators:
  - Trapped-ion qubits deliver some of the highest gate fidelities in the industry;
...
funding:
  ...
  - amount_usd: 2000000
    date: '2015-07-01'
    lead_investor: New Enterprise Associates
    other_investors:
    - GV (Google Ventures)
    round: Seed
  ...
  - amount_usd: 55000000
    ...
    source: https://en.wikipedia.org/wiki/IonQ
    stage: series_c
  - amount_usd: 636000000
    date: '2021-10-01'
    notes: Proceeds from going public via merger with dMY Technology Group III SPAC,
      including a $350M PIPE; first publicly traded pure-play quantum computing company.
    round: SPAC merger / IPO (NYSE listing)
    source: https://en.wikipedia.org/wiki/IonQ
    stage: post_ipo
...
- claim: IonQ founded by Duke University professor Christopher Monroe and Jungsang Kim,
  ...
  date: '2015-09-01'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Became the first publicly traded pure-play quantum computing company, listing
    on the NYSE under ticker IONQ via a SPAC merger with dMY Technology Group III,
    raising roughly $636 million.
  date: '2021-10-01'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Opened a dedicated quantum computing manufacturing and R&D facility in Bothell,
    Washington — described as the first quantum computer factory in the United States.
  date: '2024-02-01'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Announced acquisition of Qubitekk, a US quantum-networking company, expanding
    IonQ's quantum-networking patent portfolio and entanglement-distribution capability.
  date: '2024-11-01'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Niccolò de Masi, a board member since 2021, became President and CEO of IonQ,
    succeeding Peter Chapman, who became Executive Chair.
  date: '2025-02-26'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Acquired a controlling stake in ID Quantique (Geneva), a leader in quantum-safe
...
- claim: Acquired Lightsynq Technologies, a US startup developing photonic interconnects
    and quantum memory, to accelerate quantum networking and modular scaling.
  date: '2025-06-01'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Reported a world-record 99.99% two-qubit gate fidelity, a key threshold on
    the path to fault-tolerant trapped-ion quantum computing.
  date: '2025-07-01'
  source: https://en.wikipedia.org/wiki/IonQ
- claim: Completed the acquisition of Oxford Ionics for $1.08 billion, integrating
    Oxford's chip-scale "Electronic Qubit Control" technology and accelerating IonQ's
    roadmap to high-qubit-count fault-tolerant systems.
  date: '2025-09-17'
  source: https://www.oxionics.com/announcements/ionq-completes-acquisition-of-oxford-ionics-rapidly-accelerating-its-quantum-computing-roadmap/
- claim: Closed a $2.0 billion equity offering anchored by Heights Capital Management,
    one of the largest single capital raises in the quantum industry.
  date: '2025-10-01'
  source: https://en.wikipedia.org/wiki/IonQ
modality: hardware
name: IonQ
...
- name: AstraZeneca
  source: https://ionq.com/company
  type: customer
- name: U.S. Air Force Research Laboratory (AFRL)
  source: https://ionq.com/company
  type: research
people:
  founders:
...
- trapped_ion
products:
- description: First-generation commercial trapped-ion system, ~11 Algorithmic Qubits
    (#AQ 11), available via cloud.
  name: IonQ Harmony
  release_date: '2020-01-01'
  source: https://ionq.com/quantum-hardware
  stage: deprecated
- description: Second-generation system rated at 25 Algorithmic Qubits (#AQ 25), using
    ytterbium ions; available on AWS Braket, Azure Quantum and Google Cloud.
  name: IonQ Aria
...
- description: Flagship system rated at 36 Algorithmic Qubits (#AQ 36), introducing
  ...
  source: https://ionq.com/quantum-hardware
  stage: ga
- description: Next-generation enterprise system targeting an (#AQ 64) rating, intended
    for on-premises and data-center deployment as IonQ scales toward fault tolerance.
  name: IonQ Tempo
