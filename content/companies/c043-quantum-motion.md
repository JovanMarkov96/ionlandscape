...
approach:
  ...
  - Qubits are electron spins in silicon quantum dots built with standard 300 mm CMOS
    foundry processes
  - Delivered the industry's first full-stack silicon CMOS quantum computer (to the
    UK NQCC)
...
- claim: Delivered the industry's first full-stack quantum computer built on standard
    silicon chips, installed at the UK's National Quantum Computing Centre (NQCC).
  date: '2025-09-01'
  source: https://quantummotion.com/quantum-motion-delivers-the-industrys-first-full-stack-silicon-cmos-quantum-computer/
- claim: Selected for Stage A and subsequently advanced to Stage B of DARPA's Quantum
    Benchmarking Initiative for its MOS-based silicon spin-qubit design.
  date: '2025-11-07'
  source: https://www.datacenterdynamics.com/en/news/quantum-motion-delivers-silicon-cmos-based-quantum-computer-to-uks-national-quantum-computing-centre/
...
In September 2025 Quantum Motion delivered the industry's first full-stack silicon CMOS quantum computer to the UK's National Quantum Computing Centre, advanced to Stage B of DARPA's Quantum Benchmarking Initiative, and in 2026 closed a US$160M Series C.