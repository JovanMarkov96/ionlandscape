...
approach:
  ...
  differentiators:
  - Uses nuclear-spin qubits in ytterbium-171 atoms, providing some of the longest
    coherence times of any qubit modality (demonstrated >40 seconds)
  - AC1000 system features 1,200+ fully-connected physical qubits with all-to-all
  ...
  elevator_pitch: Atom Computing builds gate-based quantum computers using nuclear-spin
    qubits in optically trapped ytterbium-171 atoms, offering industry-leading coherence
    times, all-to-all connectivity, and 1,200+ physical qubits on the AC1000 platform,
...
links:
  ...
  wikipedia: https://en.wikipedia.org/wiki/Atom_Computing
location:
  city: Berkeley
...
- function: hq
  location:
    ...
    country: United States
    region: California
  source: https://atom-computing.com
- function: r_and_d
  location:
    city: Boulder
    country: United States
...
people:
  founders:
  - name: Ben Bloom
    role: Co-founder & CEO (2018–2021; CEO again from July 2024)
    source: https://thequantuminsider.com/2024/07/12/ben-bloom-returns-as-ceo-of-atom-computing/
  - name: Jonathan King
    role: Co-founder
    source: https://en.wikipedia.org/wiki/Atom_Computing
...
- neutral_atom
products:
- description: First-generation 100-atom quantum computing system using optically
    trapped strontium atoms with record coherence times. Unveiled July 2021.
  name: Phoenix
  release_date: '2021-07-21'
  source: https://www.prnewswire.com/news-releases/atom-computing-unveils-first-generation-quantum-computing-system----appoints-new-ceo-after-closing-15-million-in-series-a-funding-301338000.html
  stage: deprecated
- description: Second-generation gate-based quantum computer with 1,200+ nuclear-spin
    qubits in optically trapped ytterbium-171 atoms. Features all-to-all qubit connectivity,
    single-qubit gate fidelity >99.9%, two-qubit gate fidelity >99.6%, mid-circuit
    measurement with qubit reset and reuse, and real-time conditional branching. Supports
    OpenQASM and QIR. Available on-premises (~600 sq ft footprint) and via Microsoft
    Azure Quantum. First exceeded 1,000 qubits (1,180) in October 2023.
  name: AC1000
