...
approach:
  ...
  - digital_and_analog
  differentiators:
  - Neutral-atom quantum processors using atoms trapped in optical lattices, a route
  ...
  elevator_pitch: planqc builds neutral-atom quantum computers using atoms trapped
    ...
    supercomputing and aerospace quantum-computing initiatives.
entity_type: company
founded_year: 2022
funding:
...
- claim: Awarded a €29 million contract by the German Aerospace Center (DLR) to build
    a scalable 100-qubit neutral-atom quantum computer for the DLR Innovation Center
    in Ulm.
  date: '2023-01-01'
...
people:
  ...
  - name: Alexander Glätzle
    role: Co-founder & CEO
    source: https://en.wikipedia.org/wiki/Planqc
  - name: Sebastian Blatt
    role: Co-founder & CTO
    source: https://en.wikipedia.org/wiki/Planqc
  - name: Johannes Zeiher
    role: Co-founder
    source: https://en.wikipedia.org/wiki/Planqc
  spun_out_of:
...
- neutral_atom
products:
- description: Neutral-atom quantum processor using atoms (strontium) trapped in optical
...
- note: Company history, founders, funding, Munich Quantum Valley
  url: https://en.wikipedia.org/wiki/Planqc
- note: €29M DLR contract for a 100-qubit neutral-atom machine
  url: https://planqc.eu/news/planqc-awarded-eur-29-million-contract-from-the-dlr-to-build-and-install-scalable-neutral-atom-quantum-computer
- note: €50M Series A, July 2024
  url: https://www.datacenterdynamics.com/en/news/german-quantum-computing-startup-planqc-raises-50m/
- note: €20M LRZ MAQCS 1,000-qubit project
  url: https://www.hpcwire.com/off-the-wire/germany-backs-planqc-with-e20m-for-1000-qubit-neutral-atom-quantum-system-at-lrz/
status:
