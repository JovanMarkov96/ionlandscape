...
approach:
  ...
  elevator_pitch: Infleqtion (formerly ColdQuanta) is a vertically integrated cold-atom
    ...
    17+ years of BEC/laser-cooling manufacturing to address computing, sensing, and
    timing markets.
entity_type: company
founded_year: 2007
funding:
...
- function: hq
  location:
    ...
    country: United States
    region: Colorado
  source: https://www.infleqtion.com
- function: r_and_d
  location:
    city: Chicago
    country: United States
...
- rydberg_array
products:
- description: Gate-based quantum computer using Rydberg-mediated entangling gates
    in optically trapped rubidium atoms. Offers digital qubit operations with no cryogenics
    required. Available for cloud access to partners and select customers.
  name: Hilbert
  release_date: '2023-01-01'
  source: https://www.infleqtion.com/hilbert
  stage: limited_release
- description: Cloud-accessible programmable quantum matter platform — a Bose-Einstein
    condensate of ultracold rubidium atoms in an optical lattice — enabling quantum
    simulation and sensing experiments via a web interface.
  name: Oqtant
  release_date: '2021-11-01'
  source: https://www.infleqtion.com/oqtant
  stage: ga
- description: Turnkey miniaturised cold-atom and BEC hardware systems sold as standalone
    instruments or OEM modules for quantum sensing, timing, and navigation applications.
    Delivered to government labs (NIST, DARPA programmes) and academic institutions
    worldwide.
  name: Cold Atom Lab Systems / BEC Modules
