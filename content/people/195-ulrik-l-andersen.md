...
His 1998 Science paper (with Sørensen, Braunstein, Fuchs, Kimble, and Polzik) demonstrated the first unconditional quantum teleportation of continuous-variable optical states using EPR-entangled squeezed beams, achieving a fidelity of 0.58 ± 0.02 — above the 0.5 classical limit. The paper has accumulated more than 4,100 citations and is a landmark of experimental quantum information science. Subsequent highlights include the demonstration of -9 dB quadrature squeezing with improved phase stability (PRL 2007), establishing a world-leading squeezing benchmark; generation of optical Schrödinger cat states via photon subtraction from squeezed vacuum (PRL 2008); and the creation of ultra-large-scale CV cluster states containing more than 10,000 entangled temporal modes through time-domain multiplexing (Nature Photonics 2013). Most recently, his group demonstrated generation of a time-domain-multiplexed two-dimensional cluster state (Science 2019), a structure compatible with bosonic error-correcting codes and a key milestone toward fault-tolerant optical quantum computing.

Furusawa currently leads Japan's Moonshot R&D Programme Goal 6, aiming to realise a large-scale fault-tolerant optical quantum computer by 2050 using room-temperature time-domain-multiplexed cluster states. He was awarded the Purple Ribbon Medal by the Japanese government in 2017 for contributions to quantum information science. His work has accumulated more than 25,000 citations with an h-index of 68 (Google Scholar, 2026).
