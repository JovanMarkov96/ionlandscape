...
short_description: 'Ewha Womans University (Korean: 이화여자대학교; Hanja: 梨花女子大學校) is a
  ...
  Womans University is one of the world''s largest female educational institutes and
  one of the most prestigious universities in South Korea. Ewha Womans University
  has produced numerous South Korean women leaders, including politicians, CEOs, and
  legal professionals.'
sources:
- note: Imported short_description from Wikipedia (Ewha Womans University)
  url: https://en.wikipedia.org/wiki/Ewha_Womans_University
---
