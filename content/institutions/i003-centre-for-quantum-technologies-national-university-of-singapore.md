...
short_description: The Centre for Quantum Technologies (CQT) in Singapore is a Research
  ...
  on quantum physics and to build devices based on quantum phenomena. Experts in quantum
  technologies are applying their discoveries in computing, communications and sensing.
sources:
- note: Imported short_description from Wikipedia (Centre for Quantum Technologies)
  url: https://en.wikipedia.org/wiki/Centre_for_Quantum_Technologies
---
